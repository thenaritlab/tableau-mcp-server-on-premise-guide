...
| 7 | 🛡️ **แนวปฏิบัติที่ดีและความปลอดภัย** | กฎการกำกับดูแลและ checklist ก่อน go-live 14 ข้อ | [อ่าน](docs/th/07-best-practices.md) | [Read](docs/en/07-best-practices.md) | 3 นาที |
| 8 | ❓ **คำถามที่พบบ่อยและอภิธานศัพท์** | คำถาม 10 ข้อ ศัพท์ ไทย/อังกฤษ | [อ่าน](docs/th/08-faq-glossary.md) | [Read](docs/en/08-faq-glossary.md) | 2 นาที |
| 9 | 🔗 **เอกสารอ้างอิง** | ลิงก์เอกสารทางการของ Tableau, MCP และผู้ให้บริการ AI | [อ่าน](docs/th/09-references.md) | [Read](docs/en/09-references.md) | 1 นาที |
...
├── docs/
│   ├── en/             🇺🇸 Markdown 9 หน้า อ่านบน GitHub (01-overview … 09-references)
│   ├── th/             🇹🇭 Markdown 9 หน้า ลำดับเดียวกัน
