...
Viewer อ่าน view ได้ (`get-view-data`, `get-view-image`) หากมีสิทธิ์ การ query published data source ต้องมีสิทธิ์ "Connect" บน data source นั้น ซึ่งปกติให้กับ Explorer และ Creator (Viewer ถือสิทธิ์นี้ได้เช่นกัน แต่เชื่อมจาก Desktop ไม่ได้)
