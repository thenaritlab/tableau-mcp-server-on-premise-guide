[🏠 หน้าแรก](../../README.th.md) · [◀ ก่อนหน้า: แนวปฏิบัติที่ดี การกำกับดูแล และรายการตรวจสอบความปลอดภัย](09-best-practices.md) · [ถัดไป: เอกสารอ้างอิง ▶](11-references.md) · [🇺🇸 English](../en/10-faq-glossary.md)
...
Viewer อ่าน view ได้ (`get-view-data`, `get-view-image`) หากมีสิทธิ์ การ query published data source ผ่าน AI ต้องมีสิทธิ์ "View", "Connect" และ "API Access" บน data source นั้น Viewer ถือได้ทั้งสามอย่าง ดังนั้น Viewer คือ site role ขั้นต่ำ API Access ปิดอยู่โดยปริยาย เจ้าของหรือ project leader ต้องเปิดให้ Viewer ดาวน์โหลดข้อมูลเต็มหรือเชื่อมจาก Desktop ไม่ได้
...
<sub>ส่วนที่ 10 จาก 11 · Created by The Narit Lab</sub>
