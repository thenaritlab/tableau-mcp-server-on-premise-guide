[🏠 หน้าแรก](../../README.md) · [◀ ก่อนหน้า: ขั้นสูง: สร้าง Web UI ครอบ Tableau Server](06-web-ui-wrapper.md) · [ถัดไป: คำถามที่พบบ่อยและอภิธานศัพท์ ▶](08-faq-glossary.md) · [🇺🇸 English](../en/07-best-practices.md)
