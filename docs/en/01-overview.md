...
6. **Permissions, roles and licences** explains who can see what, how each MCP tool maps to Tableau capabilities, and how to design security.
7. **Enterprise proposal** is a ready-to-adapt plan for IT to build an organisation-wide BI + AI chat platform on Tableau MCP.
8. **Best practices, FAQ and references** close the loop.
...
<sub>Section 1 of 11 · Created by The Narit Lab</sub>
